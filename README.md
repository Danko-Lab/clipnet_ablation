...
`data_processing.yml` describes the conda/environment used for the data processing pipelines. Note that this is separate from the dependencies needed for CLIPNET.
